...
**Version:** 1.2 (Added Settings Panel Specification) **Target Framework:** JUCE 8 (C++20 standard) \+ React 18 **Platform:** macOS (Standalone App) **Repository Structure:** Monorepo (Engine \[C++\] / WebClient \[React/TS\] / Shared)
